...
public interface RoomsMapper {
    ...
    // ルーム作成
    @Insert("INSERT INTO rooms(invite_id, challenge_id) SELECT #{room.invite_id}, challenge_id FROM vulnerability WHERE difficult = #{vulnerabilities.difficult} ORDER BY RAND() LIMIT 1")
