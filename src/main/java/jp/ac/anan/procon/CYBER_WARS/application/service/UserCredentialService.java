...
import jp.ac.anan.procon.cyber_wars.application.utility.credential.LoggedInChecker;
import jp.ac.anan.procon.cyber_wars.application.utility.credential.SessionTimeoutUpdater;
...
public class UserCredentialService {
  ...
  public LogInResponse logIn(
    ...
    final Users user =
        userFetcherByName.fetchUserByName(stringFormatter.format(logInRequest.getName()));
    ...
    // ユーザーパスワードが異なる場合
    if (!passwordEncoder.arePasswordsEqual(
        stringFormatter.format(logInRequest.getPassword()), user.getPassword())) {
      return new LogInResponse(false);
    }
